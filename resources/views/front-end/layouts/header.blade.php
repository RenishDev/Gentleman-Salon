...
<!-- Preloader -->
<div id="preloader">
    <img src="{{ asset('media/logo.png') }}" alt="logo" class="mb-5"><br>
    <img src="{{ asset('media/preloader.gif') }}" alt="logo">
</div>
...
<header class="header style-1">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9 col-sm-9 col-12">
                    <ul>
                        ...
                        <li><a href="tel:1223456789"><i class="fas fa-mobile"></i> +00 (123) 9999</a></li>
                        <li><span><i class="fas fa-clock"></i> Everyday 7 AM to 7 PM Sunday Off</span></li>
                    </ul>
                </div>
        ...
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="hair-salon-home.html">
                <svg width="100%" viewBox="0 0 145 34" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="route(#clip0_350_910)">
                        <path
            ...
            <div class="collapse navbar-collapse" id="mynavbar-1">
                <ul class="navbar-nav ms-auto me-auto mainmenu">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="stylen-submenu">
                            <li><a href="{{ route('product') }}">Product Listing</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="stylen-submenu multiline">
                            <li><a href="{{ route('appointment') }}">Appointment 1</a></li>
                            <li><a href="{{ route('gallery') }}">Gallery</a></li>
                            <li><a href="{{ route('about') }}" class="active">About</a></li>
                            <li><a href="{{ route('contact') }}">Contact</a></li>
                            <li><a href="{{ route('team') }}">Team</a></li>
                            <li><a href="{{ route('team.detail') }}">Team Detail</a></li>
                            <li><a href="{{ route('join-team') }}">Join Team</a></li>
                            <li><a href="">404</a></li>

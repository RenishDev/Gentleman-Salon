 ...
 <footer class="footer style-1">
                     ...
                     <div class="content text-center">
                         ...
                         <div class="row">
                             ...
                             <div class="col-xl-4  col-lg-6 col-md-6 col-12">
                                 <div class="content-box">
                                     <h6>PHONE</h6>
                                     <a class="phone" href="tel:123456789"><i class="fas fa-phone-alt"></i>(888)
                                         123 4567</a>
                                 </div>
                             </div>
                             <div class="col-xl-4  col-lg-6 col-md-6 col-12 offset-xl-0 offset-lg-3 offset-md-3">
                                 <div class="content-box">
                                     <h6>EMAIL</h6>
                                     <a class="email" href="mailto:info@example.com"><i
                                             class="fas fa-envelope"></i>info@example.com</a>
                                 </div>
                             </div>
                         </div>
                     </div>
             ...
             <div class="row justify-content-between">
                 <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <p class="about">Stylen Salon provides a variety of beauty services that will help you feel
                             and appear your best. Our services range from hair care products and styling to makeup.</p>
                     </div>
                 </div>
                 <div class="col-xl-2 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <ul class="quicklinks list-unstyled">
                             ...
                             <li><a href="hair-salon-services.html">SERVICES</a></li>
                 ...
                 <div class="col-xl-3 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <ul class="quicklinks list-unstyled">
                             <li><a href="service-detail.html">Facials</a></li>
                             <li><a href="service-detail.html">Body Treatment</a></li>
                             <li><a href="service-detail.html">Mineral Baths</a></li>
                             <li><a href="service-detail.html">Waxing</a></li>
                             <li><a href="service-detail.html">Massage</a></li>
                         </ul>
                     </div>
                 </div>
                 <div class="col-xl-3 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <a class="address" href=""><i class="fal fa-map-marker-alt"></i> 4757 South Cobb
                             Dr SE Georgia, USA, 30080</a>
                     </div>
                 </div>
     ...
     <div class="footer-copyright">
         <p class="copyright-text">© 2024. All Rights Reserved by <a href="./index.html">STYLEN</a>
         </p>
     </div>
 </footer>
 <!--=====================================-->
 ...
 <footer class="footer style-2 d-none background-2">
         ...
         <div class="container">
             <div class="newsletter-box">
                 <div class="row">
                     ...
                     <form method="get" action="hair-salon-home.html" class="col-md-7">
             ...
             <div class="row justify-content-between">
                 <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <ul class="list-unstyled">
                             <li><a class="contact-link mb-2" href="tel:123456789"><i class="fas fa-phone-alt"></i>
                                     (888)
                                     123 4567</a></li>
                             <li> <a class="contact-link" href="mailto:info@example.com"><i
                                         class="fas fa-envelope"></i> info@example.com</a></li>
                         </ul>
                         <ul class="list-unstyled social-icon">
                 ...
                 <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                     <div class="footer-widget">
                         ...
                         <a href="" class="contact-link"><i class="fas fa-map-marker-alt"></i> 4757 South Cobb
                             Dr, USA, 30080</a>
                     </div>
                 </div>
     ...
     <div class="footer-copyright">
         <p class="copyright-text">© 2024. All Rights Reserved by <a href="./hair-salon-home.html">STYLEN</a>
         </p>
     </div>
 </footer>
